...
回答 (説明) に HTML コンテンツを使用したり、HTML タグを追加したりできます。 次の HTML タグがサポートされています。
...
サポートされていないタグは、無視されるか文字列として表示されます。 カードを必ずプレビューするようにします。
...
インポート機能とエクスポート機能を使用すると、次の操作を行うことができます。

- Q&A アイテムの一括追加 - Q&A テンプレート ファイルに詳細を追加して、インポートします。
- Q&A アイテムの一括編集 - Q&A を .csv ファイルにエクスポートし、エクスポートされた .csv ファイルの Q&A の詳細を編集してから、.csv ファイルをインポートします。
- Q&A アイテムのバックアップ - Q&A を .csv ファイルにエクスポートします。
...
**注:** テンプレート ファイルにエラーがある場合は、Q&A アイテムをインポートすることはできません。 エラーを回避するには、インポート ファイルが正しく書式設定されていて、必要な情報がすべて含まれていることを確認してください。 
...
- 場所の一括追加 - 場所テンプレート ファイルに詳細を追加して、インポートします。 
- 場所の一括編集 - 場所を .csv ファイルにエクスポートし、エクスポートされた .csv ファイルの場所の詳細を編集してから、更新された .csv ファイルをインポートします。
- 場所のバックアップ - 既存の場所を .csv ファイルにエクスポートします。
